...
<%@ include file="sidebar.jsp"%>
    ...
    <div class="main-wrap">
        ...
        <div class="search-wrap">
            <div class="search-content">
                <form action="<%=Const.ROOT %>users?action=checklist" method="post"   id="searchForm">
                    ...
                    <table class="result-tab" width="100%">
                        ...
                        <tr>
                         <td>${st.count}</td>
                            ...
                            <td>
                            <a class="link-update" href="<%=Const.ROOT%>users?action=checkusers&id=${u.id}">同意申请</a>
                                  <c:if test="${u.role==0}">
                                <a class="link-del" href="javascript:delcheck(${u.id})">忽略</a>
                                </c:if>
                            </td>
                        </tr>
                        </c:forEach>
    ...
    <script>
    	function delcheck(id){
    		if(confirm("是否删除 ")){
    			location.href="<%=Const.ROOT%>users?action=delcheck&id="+id;
    		}
    	}
