...
<%@ include file="sidebar.jsp"%>
    ...
    <div class="main-wrap">
		...
		<div class="search-wrap">
            <div class="search-content">
                <form action="<%=Const.ROOT%>goods?action=list" method="post"   id="searchForm">
        ...
        <div class="result-wrap">
            ...
            <c:if test="${users.role==0}">
                <div class="result-list">
                        <a href="<%=Const.ROOT%>goods?action=showgoodstype&need=${need}"><i class="icon-font"></i>新增</a>
                       </div>
                       </c:if>
                    ...
                    <table class="result-tab" width="100%">
                        ...
                        <tr>
                         ...
                         <td>${gl.goodstype.name}</td>
                            ...
                            <td>
                            	<c:if test="${users.role==0}">
                                <a class="link-update" href="<%=Const.ROOT%>message?action=list&pid=${gl.id}">查看留言</a>
                              </c:if>
                               <a class="link-update" href="<%=Const.ROOT%>goods?action=showupdate&id=${gl.id}">修改</a>
                              <a class="link-del" href="javascript:del(${gl.id})">删除</a>
    ...
    <script>
    	function del(id){
    		if(confirm("是否删除 ")){
    			location.href="<%=Const.ROOT%>goods?action=del&id="+id;
    		}
    	}
